...
Those account ids matching NFC tags, program recovery files token or others items are managed with a dedicated extended_recovery pallet  withiin TEE/Integritee validators to ensure recovery security and privacy.
