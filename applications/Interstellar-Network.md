...
- **Cross chain Swap feature** - based on a Continious Liquitity Pool (CLP like ThorChain but with higher security and performance) - leverage TEE/MPC/TTS + Trusted Transaction Validation protocol with a mutisig option (mobiles + yubikey) for Validators and large liquitity owners
