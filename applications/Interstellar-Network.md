...
- Math Wallet is based on MPC that requires heavier computation ressources. They also envision smartcard with screen for users. It's comparable to our level of security, but more expensive, cumbersome to use, less flexible and more complex to deploy than our solution.
