...
- **User experience**  [Can an easy to set-up wallet be an efficient customer aquisition tool for DeFi players?](https://medium.com/@jlleleu/can-be-an-easy-to-set-up-wallet-an-efficient-customer-acquisition-tool-for-defi-players-8600812fe01e)  
...
![HW2Interstellar drawio](https://user-images.githubusercontent.com/4605611/145072052-0b145054-b8c8-45bc-96cd-ee39f0f7fe60.png)
...
- **Features to securely send coins with social network messages (even to person with no-wallet)** - [Can an easy to set-up wallet be an efficient customer aquisition tool for DeFi players?](https://medium.com/@jlleleu/can-be-an-easy-to-set-up-wallet-an-efficient-customer-acquisition-tool-for-defi-players-8600812fe01e)
...
We want to target in priority Dapp providers in the DeFi ecosystem with develloper tools to integrate our solution with their Dapps. We think that our value proposition should be attractive to them.
...
- Math Wallet is based on MPC that requires heavier computation ressources. They also envision smartcards with screen for users. It's comparable to our level of security, but more expensive, cumbersome to use, less flexible and more complex to deploy than our solution.
