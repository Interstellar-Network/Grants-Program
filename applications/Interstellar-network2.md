...
|      1. | Sunstrate/Integrtee - Signer/Key Manager | We will create a pallet to manage signers associated with private key management                                                                                                                                                              |
|      2. | Substrate/Integritee - Polkadot signer    | We will create a pallet to sign Polkadot transaction                                                                                                                                                                                          |
|      3. | Substrete/Integritee - Ethereum signer    | We will create a pallet to sign Ethereum transaction                                                                                                                                                                                          |
|      4. | Substrate/Integritee Module - submit transaction | We will create a pallet to send transactions to the appropriate network                                                                                                                                                                  |
> su
